...
For this project, I trained an agent to navigate (and collect bananas!) in a large, square world. The resulting code is contained in an interactive notebook.
